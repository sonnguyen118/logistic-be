...
router.post('/upload', authMiddleware.authenticateRequest, authMiddleware.authorize, upload.single('file'), authMiddleware.authorizeUploadFile, orderController.uploadOrdersFromExcelFile);
